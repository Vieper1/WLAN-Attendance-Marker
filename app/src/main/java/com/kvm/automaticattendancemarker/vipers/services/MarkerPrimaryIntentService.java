...
/**
 * Created by Viper GTS on 09-Jan-17.
 */

// TODO: Convert IntentService to Service

public class MarkerPrimaryIntentService extends IntentService
{
    ...
    ////////////////////////////////////////////////////////////////////// Comms
    public static final String COMMS_RESULT = "com.kvm.automaticattendancemarker.vipers.services.MarkerPrimaryIntentService.REQUEST_RESULT";
    public static final String COMMS_MESSAGE = "com.kvm.automaticattendancemarker.vipers.services.MarkerPrimaryIntentService.COMMS_MESSAGE";
    private LocalBroadcastManager broadcaster;

    public void sendResult(String message)
    {
        Intent intent = new Intent(COMMS_RESULT);
        if(message != null)
        {
            intent.putExtra(COMMS_MESSAGE, intent);
        }
    ...
    public MarkerPrimaryIntentService()
    {
        super(MarkerPrimaryIntentService.class.getName());
    }
...
//        timerHandler.postDelayed(timerRunnable, sessionLength + sessionLengthCorrection);
